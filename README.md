...
<img alt="Превью режима разработки" src="/.kitpreview/devmode.png">

Тем временем в браузере:

<img alt="Превью окна браузера" src="/.kitpreview/inbrowser.png">
...
<img alt="Превью окна браузера" src="/.kitpreview/startmode.png">
